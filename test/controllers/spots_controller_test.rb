...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { city_id: @spot.city_id, description: @spot.description, name: @spot.name } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { city_id: @spot.city_id, description: @spot.description, name: @spot.name } }
